...
const Dashboard = () => {
  ...
  // ✅ Now just render WellEd and pass props it used before
  return (
    <WellEd
      user={user}
      navigate={navigate}
...
/* ========= moved OUTSIDE to keep identity stable ========= */
...
function WellEd({
  ...
  return (
    <div
      className="bg-light"
      style={{ backgroundColor: "#FFFBF2", minHeight: "100vh", fontFamily: "Inter, sans-serif" }}
    >
        ...
        <main className="mt-5 row g-4">
          ...
          <div className="col-lg-4 bg-warning bg-opacity-25 rounded shadow-sm p-4">
            ...
            <div className="mt-4 mx-4">
              {[
                { title: "QUIZ", author: "By WellEd", img: "quiz.jpg", route: "/quiz" },
                { title: "STUDY METHODS", author: "By WellEd", img: "stmth.jpg", route: "/study-methods" },
              ].map((lesson, idx) => (
                <div
                  key={idx}
